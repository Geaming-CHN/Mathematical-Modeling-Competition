...
- [层次分析法（AHP）](#层次分析法ahp)
  ...
  - [一致性检验](#一致性检验)
  - [判别矩阵求权重](#判别矩阵求权重)
    - [方法1：算术平均法求权重](#方法1算术平均法求权重)
    - [方法2：几何平均法求权重](#方法2几何平均法求权重)
    - [方法3：特征值法求权重](#方法3特征值法求权重)
  - [汇总结果得到权重矩阵](#汇总结果得到权重矩阵)
  - [计算各方案的得分](#计算各方案的得分)
  - [$\large\color{red}{\bold{总结}}$](#largecolorredbold总结)
    - [层次分析法第一步](#层次分析法第一步)
    - [层次分析法第二步](#层次分析法第二步)
    - [层次分析法第三步](#层次分析法第三步)
    - [层次分析法第四步](#层次分析法第四步)
    - [层次分析法的一些局限性](#层次分析法的一些局限性)
  - [模型拓展](#模型拓展)
